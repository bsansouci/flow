...
external throw : 'a -> 'a = "throw" [@@bs.val]
...
external setRetErrors : 'a -> string -> 'a -> unit = "" [@@bs.set_index]
external setEName : 'a -> string -> 'a -> unit = "" [@@bs.set_index]
external newError : 'a -> 'a = "Error" [@@bs.new]
